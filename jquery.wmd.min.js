...
var currTime=new Date().getTime();elapsedTime=currTime-prevTime;pushPreviewHtml(text);htmlOut=text;};var previewRefresh=function(){makePreviewHtml();if(wmd.options.previewRefreshCallback){wmd.options.previewRefreshCallback();}};var applyTimeout=function(){if(timeout){top.clearTimeout(timeout);timeout=undefined;}
