...
var currTime=new Date().getTime();elapsedTime=currTime-prevTime;pushPreviewHtml(text);htmlOut=text;$(wmd.panels.preview).find("code").replaceWith(function(){return $("<code>"+
